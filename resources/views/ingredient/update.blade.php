<form id="form-update-ingredient" action="{{ route('ingredient.update', $ingredient->id) }}" method="post">
    @csrf
    @method('PUT')
    <div class="row mb-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="ingredientName" type="text" class="form-control" name="ingredientName" required
                           placeholder="Название ингредиента" value="{{ $ingredient->name }}" autofocus>
                </div>
            </div>
        </div>
    </div>
